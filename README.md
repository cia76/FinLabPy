# FinLabPy
Универсальная система автоторговли "Финансовая Лаборатория" от Игоря Чечета.
...
- Запускать реальную автоматическую торговлю
...
4. Установите этот репозиторий
5. Установите все требуемые библиотеки через **pip install -r requirements.txt**
6. Настройте файл **Config.py** по приложенному образцу
