Расширим пример из предыдущего урока. Подключим вашего брокера, и посмотрим свободные средства и стоимость позиций на нём.
...
## Создание хранилища и получение брокера
